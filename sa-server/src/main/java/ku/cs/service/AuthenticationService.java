...
public class AuthenticationService {
    ...
    public AccessToken registerToken(Customer customer) {
        AccessToken accessToken = new AccessToken(this.generateToken());
        this.MAP.put(accessToken, customer.getCustomerId());

        return accessToken;
    }

    public AccessToken registerEmployeeToken(Employee employee) {
        AccessToken accessToken = new AccessToken(this.generateToken());
        this.MAP.put(accessToken, employee.getEmployee_ID());
